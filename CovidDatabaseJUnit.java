...
public class CovidDatabaseJUnit{
    ...
    {
        database= new CovidDatabase(); 
        database.readCovidData("C:\\Users\\cscha\\FinalProjectJavaTwo\\covid_data.csv");        assertEquals("ArrayList should not contain 10346 records",
    ...
    {
        database= new CovidDatabase(); 
        database.readCovidData("C:\\Users\\cscha\\FinalProjectJavaTwo\\covid_data.csv");
